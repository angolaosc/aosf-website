    ...
    <Wrapper image={backgroundImg}>
      <div className="menu__container">
        <div id="">
          ...
          <div className="listButton">
            <motion.button
              ...
              onClick={() =>
                openExternalLink(
                  "https://events.mlh.io/events/10184-angola-open-source-fest-hacktoberfest-edition"
                )
              }
            >
            ...
            <motion.button
              className="cta hackathon"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: 2.4 }}
              onClick={() =>
                openExternalLink("https://unstop.com/o/nRNxQZ4?lb=t91qM2wi")
              }
            >
        ...
        <div className="organizers">
          ...
          >
            <Logo />
            <Image src={CHAOSS_AFRICA_LOGO_opt} alt="CHAOSS_AFRICA" className="chaoss"/>
          </motion.div>
        </div>
      </div>
    </Wrapper>
